...
<?php $phien_ban=get_field('link1');
$changelog=get_field('link2');
$ngay_cap_nhat=get_field('link3');
$huong_dan_su_dung=get_field('link4');
?>
...
<div class="thong-tin-ky-thuat chang1" id="taixuong">
    ...
    <?php if($link1){?>
    <div class="right"><a href="<?php the_field('link1');?>" target="blank"><i class="fas fa-arrow-alt-circle-down" aria-hidden="true"></i> Tải .PDF</a></div>
    <?php } else {?>
    ...
    <?php if($link2){?>
    <div class="right"><a href="<?php the_field('link2');?>" target="blank"><i class="fas fa-arrow-alt-circle-down" aria-hidden="true"></i> Tải .EPUB</a></div>
    <?php } else {?>
    <div class="right">Updating...</div>
    <?php }?>
    </div>
    ...
    <?php if($link3){?>
    <div class="right"><a href="<?php the_field('link3');?>" target="blank"><i class="fas fa-arrow-alt-circle-down" aria-hidden="true"></i> Tải .AZW3</a></div>
    <?php } else {?>
    <div class="right">Updating...</div>
    <?php }?>
    </div>
    <?php if($link4){?>
    <div class="row-info">
    <div class="left"><?php the_title(); ?> .MOBI</span></div>
    <div class="right"><a href="<?php the_field('link4');?>" target="blank"><i class="fas fa-arrow-alt-circle-down" aria-hidden="true"></i> Tải .MOBI</a></div>
    </div>
    <?php }?>
    <?php if($link5){?>
    <div class="row-info">
    <div class="left"><?php the_title(); ?> .PRC</span></div>
    <div class="right"><a href="<?php the_field('link5');?>" target="blank"><i class="fas fa-arrow-alt-circle-down" aria-hidden="true"></i> Tải .PRC</a></div>
    </div>
    <?php }?>
    <?php if($link6){?>
    <div class="row-info">
    <div class="left"><?php the_title(); ?> .CBR</span></div>
    <div class="right"><a href="<?php the_field('link6');?>" target="blank"><i class="fas fa-arrow-alt-circle-down" aria-hidden="true"></i> Tải .CBR</a></div>
    </div>
    <?php }?>
    <?php if($link7){?>
    <div class="row-info">
    <div class="left"><?php the_title(); ?> .CBZ</span></div>
    <div class="right"><a href="<?php the_field('link7');?>" target="blank"><i class="fas fa-arrow-alt-circle-down" aria-hidden="true"></i> Tải .CBZ</a></div>
    </div>
    <?php }?>
</div>
<div class="fb-comments binhluanfb" data-href="<?php the_permalink(); ?>" data-lazy="true" data-width="100%" data-numposts="5"></div>