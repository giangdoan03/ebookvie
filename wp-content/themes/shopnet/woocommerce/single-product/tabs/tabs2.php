...
if ( $terms && ! is_wp_error( $terms ) ) {
    foreach ( $terms as $term ) {
        ...
        if(!empty($description)) {
            ...
            $short_description = substr($description, 0, 510); // Lấy 200 ký tự đầu tiên của nội dung
...
<div class="thong-tin-ky-thuat chang1" id="taixuong">
    ...
    <?php }?>
<div class="hotro1">Nếu không tải được ebook, ebook không có định dạng phù hợp, không biết chuyển định dạng ebook để phù hợp với thiết đọc sách... thì để lại bình luận bên dưới hoặc nhắn tin cho chúng mình <a rel="nofollow noopener" class="hotro2" href="https://m.me/ebookviecom/">Tại Đây Nhé</a></div>
</div>
