...
<div class="row mb-0 content-row">
    ...
    <div class="box-live-demo">
        <div class="left">
        	<a class="save-book"><i class="fa fa-heart"></i><span>Lưu vào Tủ sách</span></a>
           
        </div>
        <div class="right">
            <a href="https://ebookvie.com/tu-sach/"><i class="fa fa-user-edit"></i><span>Đến Tủ sách</span></a>
        </div>
    </div>
	 <script>
                (function($) {
