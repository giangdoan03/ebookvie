	...
	<div class="product-small box <?php echo flatsome_product_box_class(); ?>">
		...
		<div class="box-text <?php echo flatsome_product_box_text_class(); ?>">
							    ...
							    <div class="tdk-product-loop-custom-product-meta">
							        <span class="last-updated-date"><i class="far fa-eye"></i><span><?php 
   $a = getPostViews(get_the_ID());
echo $a *=3;?></span></span><span class="version"><i class="fas fa-arrow-alt-circle-down"></i><?php 
   $b = getPostViews(get_the_ID());
echo $b;?></span></div>
