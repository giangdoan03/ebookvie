...
function my_custom_upload_directory($upload) {
    // Kiểm tra nếu chúng ta đang tải lên một file .epub
    if (strpos($upload['type'], 'epub') !== false) {
        $upload['subdir'] = '/epub' . $upload['subdir'];
...
// Thêm bộ lọc thư mục tải lên trước khi tải file lên
...
// Xóa bộ lọc thư mục tải lên sau khi tải file lên
